<?php namespace Predis\Async\Connection;
...
abstract class AbstractConnection implements ConnectionInterface
{
    ...
    /**
     * Returns a wrapper to the user-provided callback used to handle response chunks streamed
     * by replies to commands such as MONITOR, SUBSCRIBE, etc.
     *
     * @return \Closure
     */
    ...
    public function onConnect()
    {
        ...
        // to detect connectionn refused errors with PHP's stream sockets. You
    ...
    public function read()
    {
        ...
        {
            return $this->onError(new ConnnectionException($this, 'Error while reading bytes from the server'));
        }
